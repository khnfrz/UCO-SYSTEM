...
import { DesktopSidebarWrapper } from './layout/DesktopViewing';
import { MobileSidebarWrapper } from './layout/MobileViewing';

const navItems = [
  { label: 'Dashboard Overview', href: '/dashboard' },
  { label: 'Form Submissions', href: '/submissions', badge: 14 },
  { label: 'Media Analytics', href: '#' },
  { label: 'UCO Team Calendar', href: '#' },
