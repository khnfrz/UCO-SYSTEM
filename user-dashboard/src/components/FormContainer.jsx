...
export default function FormContainer() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Progress Bar */}
      ...
      <div className="p-8 md:p-12">
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="w-16 hidden sm:block"></div> {/* Spacer for balanced alignment */}
        </div>
